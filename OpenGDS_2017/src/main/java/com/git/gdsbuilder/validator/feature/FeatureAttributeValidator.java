...
public interface FeatureAttributeValidator {
	...
	/**
	 * 검수 항목 중 "교량명 오류(Bridge Name)" 검수 @author JY.Kim @Date 2017. 8. 16. 오후
	 * 2:16:42 @param simpleFeature @param relationSimpleFeature @return
	...
	/**
	 * 검수 항목 중 "행정경계 오류(Admin)" 검수 @author JY.Kim @Date 2017. 8. 16. 오후
	 * 2:15:28 @param simpleFeatureI @param simpleFeatureJ @return
	 * ErrorFeature @throws
	 */
	...
	/**
	 * 검수 항목 중 "UFID 길이오류(UFID Length)" 검수 @author JY.Kim @Date 2017. 8. 16. 오후
	 * 2:14:27 @param simpleFeature @param length @return ErrorFeature @throws
	 */
