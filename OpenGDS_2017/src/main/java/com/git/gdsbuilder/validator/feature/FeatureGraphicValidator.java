...
public interface FeatureGraphicValidator {
	...
	public List<ErrorFeature> validateNodeMiss(SimpleFeature simpleFeature,List<SimpleFeature> relationSimpleFeature, double tolerence ) throws SchemaException;
}
