...
*  
*/
public class BuildingSiteDanger extends ValidatorOption{
	...
	public enum Type{
		...
		BUILDINGSITEDANGER("BuildingSiteDanger", "GeometricError");
	 ...
	 * @param relationType
	 */
	public BuildingSiteDanger(HashMap<String, Object> attributeKey, List<String> relationType) {
		super();
		this.attributeKey = attributeKey;
		this.relationType = relationType;
	}
	
	public BuildingSiteDanger(){
		super();
