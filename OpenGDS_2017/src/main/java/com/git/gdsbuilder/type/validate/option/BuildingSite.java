...
*  
*/
public class BuildingSite extends ValidatorOption{
	...
	public enum Type{
		...
		BUILDINGSITE("BuildingSite", "GeometricError");
	 ...
	 * @param relationType
	 */
	public BuildingSite(HashMap<String, Object> attributeKey, List<String> relationType) {
		super();
