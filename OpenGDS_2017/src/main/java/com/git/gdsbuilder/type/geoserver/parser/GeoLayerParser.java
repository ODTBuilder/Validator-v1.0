...
public class GeoLayerParser {
	...
	public GeoLayerParser(String workspaceName, DataStore dataStore, String fullLayerName)
			throws FileNotFoundException, IOException, ParseException, SchemaException {
		this.workspaceName = workspaceName;
		this.dataStore = dataStore;
		this.layer = layerParse(fullLayerName);
	}
	...
	public GeoLayer layerParse(String fullLayerName) throws IOException {
		if (this.dataStore != null) {
			SimpleFeatureCollection sfc = null;
			try {
				SimpleFeatureSource source = this.dataStore.getFeatureSource(workspaceName + ":" + fullLayerName);
