...
public class DTDXFTables {
	...
	public static LinkedHashMap<String, Object> getLayerValues(DTDXFLayer qa10Layer) {
	...
	public void setLayerValues(DTDXFLayerList qa10LayerList) {
