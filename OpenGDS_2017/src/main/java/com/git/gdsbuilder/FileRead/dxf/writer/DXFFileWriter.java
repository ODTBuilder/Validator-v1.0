...
public class DXFFileWriter {
	...
	public Map<String, Object> writeDxfFile(DTDXFLayerCollection qa10LayerCollection, DTDXFLayer errQA20Layer)
			throws IOException {
	...
	private void writeBlockSection(DTDXFBlocks qa10Blocks) throws IOException {
	...
	private void writeEntitesSection(DTDXFEntities qa10Entities, DTDXFLayer errQA20Layer) throws IOException {
		...
		// err
		DTDXFEntities entity = new DTDXFEntities();
	...
	private void writeTablesSection(DTDXFTables qa10Tables, DTDXFLayer errQA20Layer) throws IOException {
	...
	private void writeLAYER(Map<String, Object> layers, DTDXFLayer errQA20Layer) throws IOException {
		...
		// err
		LinkedHashMap<String, Object> layer = DTDXFTables.getLayerValues(errQA20Layer);
	...
	private void writeDefaultHeaderSection(DTDXFHeader qa10Header) throws IOException {
