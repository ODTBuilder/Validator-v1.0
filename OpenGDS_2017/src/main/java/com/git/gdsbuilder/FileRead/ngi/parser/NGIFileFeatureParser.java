...
public class NGIFileFeatureParser {
	 ...
	 * @param ndaReader
	 */
	public NGIFileFeatureParser(BufferedReader ngiReader, BufferedReader ndaReader) {
	 ...
	 * @param ngiReader
	 */
	public NGIFileFeatureParser(BufferedReader ngiReader) {
		this.ngiReader = ngiReader;
	}
	 ...
	 * @throws IOException
	 */
	private DTNGIFeature parserDTPointFeature(String featureID, String text) throws IOException {
		...
		DTNGIFeature feature = new DTNGIFeature(featureID, "TEXT", null, null, point, graphicID, textValue, null);
		return feature;
	}
	 ...
	 * @throws IOException
	 */
	private DTNGIFeature parserDTPointFeature(String featureID) throws IOException {
		...
		Geometry point = factory.createPoint(coor);
		String graphicID = getGraphicID();
		DTNGIFeature feature = new DTNGIFeature(featureID, "POINT", null, null, point, graphicID);
		return feature;
	}
	 ...
	 * @throws IOException
	 */
	private DTNGIFeature parserDTLineStringFeature(String featureID) throws IOException {
		...
		String graphicID = getGraphicID();
		DTNGIFeature feature = new DTNGIFeature(featureID, "LINESTRING", null, String.valueOf(count), lineString,
				graphicID);
		return feature;
	 ...
	 * @throws IOException
	 */
	public DTNGIFeature parserDTPolygonFeature(String featureID) throws IOException {
