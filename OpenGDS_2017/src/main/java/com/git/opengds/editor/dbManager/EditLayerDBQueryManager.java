...
public class EditLayerDBQueryManager {
	...
	public HashMap<String, Object> selectFeatureQuery(String tableName, String featureID) {
	...
	public HashMap<String, Object> deleteFeatureQuery(String tableName, int fIdx) {
	...
	public HashMap<String, Object> insertFeatureQuery(String tableName, int fId, QA20Feature feature) {
		...
		String insertDefaultValues = " values(" + fId + "," + "'" + feature.getFeatureID() + "'," + "'" + featureType
