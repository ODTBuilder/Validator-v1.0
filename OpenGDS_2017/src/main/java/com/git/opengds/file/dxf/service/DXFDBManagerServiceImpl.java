...
public class DXFDBManagerServiceImpl implements DXFDBManagerService {
	...
	@Override
	// @Transactional
	public GeoLayerInfo insertQA10LayerCollection(UserVO userVO, DTDXFLayerCollection layerCollection,
	...
	public GeoLayerInfo dropQA10LayerCollection(UserVO userVO, DTDXFLayerCollection collection, GeoLayerInfo layerInfo)
