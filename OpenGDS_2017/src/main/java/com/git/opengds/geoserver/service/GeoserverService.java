...
public interface GeoserverService {
	 ...
	 * @return boolean
	 */
	public boolean updateFeatureType(UserVO userVO, final String orginalName, final String name, final String title,
			final String abstractContent, final String style, boolean attChangeFlag);
}