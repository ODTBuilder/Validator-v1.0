...
public class ValidatorServiceImpl implements ValidatorService {
	...
	public JSONObject validate(String jsonObject) throws Exception {
		...
		// HashMap<String, Object> valdateObj =
		// parserManager.parseValidateObj(jsonObject);
		// ValidateLayerTypeList validateLayerTypeList = (ValidateLayerTypeList)
		// valdateObj.get("typeValidate");
		// GeoLayerCollectionList collectionList = (GeoLayerCollectionList)
		// valdateObj.get("collectionList");
		//
		// // 검수수행
		// ValidateLayerCollectionList validateLayerCollection = new
		// ValidateLayerCollectionList(collectionList,
		// validateLayerTypeList);
		// CollectionValidator validator = new
		// CollectionValidator(validateLayerCollection);
