...
<jsp:include page="/WEB-INF/views/common/header.jsp" />
  ...
  <div class="demo">
    <div class="login">
      <div style="padding-top:100px; text-align:center;inline-block">
        <!--  <img src="logo.png" class="logo" style="margin-top:100px; margin-left:20px"> !-->
          <img src="${pageContext.request.contextPath}/resources/img/loginlogo.png" style="width: 80%;height: auto; "class="logo">
      </div>
