		...
		<div class="demo">
			<div class="login">
				<div style="padding-top: 100px; text-align: center;">
					<img
						src="${pageContext.request.contextPath}/resources/img/ogds.png"
						style="width: 80%; height: auto;" class="logo">
				</div>
            ...
            <path
						...
						<input type="text" id='id' class="login__input name"
            ...
            <path
						...
						<input type="password" id='pw' class="login__input pass"
