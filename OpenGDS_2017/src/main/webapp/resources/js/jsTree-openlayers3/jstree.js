		...
		(function($, undefined) {
			...
			$.jstreeol3.core.prototype = {
				...
				setUniqueLayerZIndex : function(layer, zidx) {
					...
					} else if (layer instanceof ol.layer.Tile && layer.get("git").fake === "parent") {
						layer.setZIndex(zidx);
						lastZidx++;
				...
				setUniqueLayerId : function(layer, id) {
					...
					if (typeof layer.get("treeid") !== "string") {
						...
						} else if (layer instanceof ol.layer.Tile && layer.get("git").hasOwnProperty("fake")) {
					...
					if (layer instanceof ol.layer.Vector) {
						...
						if (layer.get("git")) {
							...
							if (git.hasOwnProperty("fake")) {
								if (git["fake"] !== false && git["fake"] === "parent") {
									if (git.editable && git.hasOwnProperty("geometry")) {
										switch (git.geometry) {
										case "Point":
											obj.type = git.geometry;
								...
								} else if (git["fake"] !== false && git["fake"] === "child") {
									if (git.editable && git.hasOwnProperty("geometry")) {
										switch (git.geometry) {
										case "Point":
											obj.type = git.geometry;
