...
if (!gitbuilder.ui)
	gitbuilder.ui = {};
gitbuilder.ui.LayerDefinition10 = $.widget("gitbuilder.layerdefinition10",
		{
			widnow : undefined,
			layerDef : undefined,
			tbody : undefined,
			...
			_create : function() {
				...
				this.update();
				$(document).on("click", ".layerdefinition10-del", function(event) {
					var laName;
...
//							var ty2 = $("<option>").text("Line").val("line");
							...
							this._addClass(delBtn, "layerdefinition10-del");
							var td5 = $("<td>").append(delBtn);
							var radio = $("<input>").attr({
								"type" : "radio",
								"name" : "layerdefinition10-area"
							}).css({
								"vertical-align" : "-webkit-baseline-middle"
							});
