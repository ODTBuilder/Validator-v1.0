...
if (!gb.geoserver)
	gb.geoserver = {};
gb.geoserver.DeleteGroupLayer = function(obj) {
	var that = this;
	var options = obj;
...
gb.geoserver.DeleteGroupLayer.prototype.setClientReference = function(refer) {
	this.clientRefer = refer;
};
gb.geoserver.DeleteGroupLayer.prototype.getClientReference = function() {
	return this.clientRefer;
};
gb.geoserver.DeleteGroupLayer.prototype.setReference = function(refer) {
	this.refer = refer;
};
gb.geoserver.DeleteGroupLayer.prototype.getReference = function() {
	return this.refer;
};
gb.geoserver.DeleteGroupLayer.prototype.isEditing = function(ids) {
	var result = false;
...
gb.geoserver.DeleteGroupLayer.prototype.alert = function() {
	this.isEditing();
	this.window.modal('show');
	// var alert =
	// gb.geoserver.DeleteGroupLayer.prototype.save(obj);
};
gb.geoserver.DeleteGroupLayer.prototype.save = function(obj) {
	var that = this;
	$.ajax({
		url : this.getUrl(),
		method : "POST",
...
gb.geoserver.DeleteGroupLayer.prototype.addStructure = function(format, mapsheet, scope, layers) {
...
gb.geoserver.DeleteGroupLayer.prototype.getStructure = function() {
	return this.structure;
};
gb.geoserver.DeleteGroupLayer.prototype.setStructure = function(obj) {
	this.structure = obj;
};
gb.geoserver.DeleteGroupLayer.prototype.setUrl = function(url) {
	if (typeof url === "string") {
		this.url = url;
	}
};
gb.geoserver.DeleteGroupLayer.prototype.getUrl = function() {
	return this.url;
};